"""
Lambda Handlers - Individual route handlers
Each handler corresponds to a specific API endpoint
Clean separation of concerns: handlers only handle HTTP I/O
...
from ..infrastructure.repository_factory import get_auth_repository
from .response_builder import create_success_response
from .error_handler import handle_error
from .request_parser import parse_body, extract_bearer_token, extract_path_parameter
...
def user_info_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    """
    Handler for getting user info from token
    GET /user-info
