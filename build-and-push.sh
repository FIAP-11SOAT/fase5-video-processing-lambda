...
ECR_REPOSITORY_NAME="fase5-video-processing-lambda-auth-lambda-ecr"
IMAGE_TAG="${1:-latest}"
...
docker build -t ${ECR_REPOSITORY_NAME}:${IMAGE_TAG} -t ${FULL_IMAGE_NAME} -f deploy/docker/auth/Dockerfile .
